...
public class UI_TrangChu extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		// TODO Auto-generated method stub
				...
				///////////////////////////////////////////////////////////////////
				/*
				 * if(sou.equals(btnBanHang)) { UI_BanHang frmBanHang = new UI_BanHang();
				 * this.dispose(); } else if(sou.equals(btnTimKiem)){ UI_TimKiem frmTimKiem= new
				 * UI_TimKiem(); this.dispose(); } else
				 */
